...
export const finance: Translations = {
  ...
  currencyExchangeDesc: { 
    en: "A professional-grade currency conversion utility designed for the GCC regional landscape. Convert between 40+ world currencies with high-fidelity live rates.", 
    ar: "أداة تحويل عملات احترافية مصممة للمشهد الإقليمي الخليجي. حوّل بين أكثر من 40 عملة عالمية بأسعار مباشرة عالية الدقة." 
  },
  ...
  currencyDetailBody: { 
    en: "The monetary landscape of the Gulf Cooperation Council is characterized by a high degree of stability, largely due to the long-standing policy of pegging regional currencies to the United States Dollar (USD).", 
    ar: "يتميز المشهد النقدي لدول مجلس التعاون الخليجي بدرجة عالية من الاستقرار، ويرجع ذلك إلى حد كبير إلى السياسة القائمة منذ فترة طويلة والمتمثلة في ربط العملات الإقليمية بالدولار الأمريكي (USD)." 
  },
